...
class XuxemonsController extends Controller
{
     ...
     */
    public function show(Xuxedex $xuxemons)
    {
        try {
    ...
    public function showOne(Xuxedex $xuxemons)
    {
     ...
     */
    public function update(Request $request, Xuxedex $xuxemons)
    {
     ...
     */
    public function destroy(Xuxedex $xuxemons)
    {
        try {
